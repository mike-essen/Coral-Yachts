                        ...
                        <div class="r-best-offer-single">
                            <div class="r-best-offer-in">
                                <div class="r-offer-img">
                                    <a class="d-inline-block" href="#"><img style="max-width:179px;"
                                                                            src="{{ asset('images/-hero-yacht1.jpg') }}"
                                ...
                                <div class="r-best-offer-content">
                                    <a href="#"><b>OceAno </b>X90</a>
                                    <p>Start at <b>500.00 USD</b> per day</p>
            ...
            <div class="container">
                <div class="owl-carousel r-latest-news-list" id="r-latest-news-slider">
                    <div class="r-latest-news-single">
                        <a class="d-inline-block"><img src="{{ asset('images/-weed.jpg') }}" class="img-fluid d-block m-auto"
                                                       alt=""></a>
                    ...
                    <div class="r-latest-news-single">
                        <a class="d-inline-block"><img src="{{ asset('images/-wizard.jpg') }}" class="img-fluid d-block m-auto"
                                                       alt=""></a>
                        <div class="r-latest-news-content">
