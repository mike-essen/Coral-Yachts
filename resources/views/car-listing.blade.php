              ...
              <div class="container">
                <div class="row clearfix">
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div class="r-logo">
                      <a href="index.blade.php" class="d-inline-block"><img src="assets/images/logo.png" class="img-fluid d-block" alt=""></a>
                    </div>
                    <a href="javaScript:void(0)" class="menu-icon"> <i class="fa fa-bars"></i> </a>
                  </div>
                  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-xs-12">
                    <div class="r-header-action float-right">
                      <a href="login-register.blade.php"> <img src="assets/images/icon-lock.png" alt='' /> <span>Login</span></a>
                      ...
                      <nav>
                        <ul>
                          <li class="r-has-child">
                            ...
                            <ul class="pl-0 ml-0">
                              <li><a href="index.blade.php">Home 01</a></li>
